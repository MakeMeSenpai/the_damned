...
import random
# imports Heroes
from Components.Heroes import heroes
from Components.Heroes import angle
...
# imports Towers
from Components.Towers import towers
from Components.Towers.Shooters import peddle_shooter
from Components.Towers.Shooters import mage
from Components.Towers.Roadblock import  blockade_burgade
...
class Game:
    def __init__(self):
        ...
        self.heroes = ["Demon"] #, "Werewolf", "Vampire"]
